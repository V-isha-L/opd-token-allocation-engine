...
app.post("/submit", (req, res) => {
  let randomNumForAdj = Math.floor(Math.random() * adj.length) +1;
  let randomNumForNoun= Math.floor(Math.random() * noun.length) +1;

  let BandName = adj[randomNumForAdj] + " " + noun[randomNumForNoun];
